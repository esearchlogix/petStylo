...
class ProductDetailViewController: UIViewController,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        scrollViewShipment?.contentInset=UIEdgeInsetsMake(64.0,0.0,50.0,0.0);
...
//        textFieldColour?.rightViewMode = UITextFieldViewMode.always
    ...
    //Give border to view
        ...
        let attributedString = NSMutableAttributedString(string: "Product Description", attributes: [NSAttributedStringKey.underlineStyle : true])
    ...
    func loadContent(){
      ...
      // button code
        ...
        addToCartButton?.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 10)
        addToCartButton?.titleEdgeInsets = UIEdgeInsetsMake(0, 10, 0, 0)
    }
            ...
            if let checkout1 = checkout.checkout {
                ...
                if isLogIn == true{
                    ...
                    if tokenActiveDate > Date(){
                        ...
                        destinationViewController.totalCartPrice = totalPrice
