...
var baseUrl:String {
    ...
    return String(format:"https://a74ea1421fb13439b649fe9d44e0f3f6:3b423920ac3190c872a7c1569763da3f@petstylo.myshopify.com/admin/")
...
var featuredProductUrl:String{
    return String(format: baseUrl+"products.json?collection_id=437611087")
}
