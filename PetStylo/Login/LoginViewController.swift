...
class LoginViewController: UIViewController,UITextFieldDelegate,GIDSignInDelegate,GIDSignInUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        Utility.giveDoubleBorderToView(view: viewLogIn!, colour: UIColor.white)
        Utility.giveDoubleBorderToView(view: textFieldUserName!, colour: UIColor.white)
        Utility.giveDoubleBorderToView(view: textFieldPassword!, colour: UIColor.white)
//        Utility.giveShadowEffectToView(view: textFieldUserName!)
//        Utility.giveShadowEffectToView(view: textFieldPassword!)
        Utility.giveShadowEffectToView(view: buttonLogIn!)
        Utility.giveShadowEffectToView(view: buttonSignUp!)
        Utility.giveShadowEffectToView(view: viewLogIn!)
 
        textFieldUserName?.attributedPlaceholder = NSAttributedString(string: (textFieldUserName?.placeholder)!,
