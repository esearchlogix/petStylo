...
//  PetStylo
//
//  Created by Alekh Verma on 17/09/18.
...
class AppDelegate: UIResponder, UIApplicationDelegate,ServerCallback,UNUserNotificationCenterDelegate, MessagingDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        PayPalMobile .initializeWithClientIds(forEnvironments: [PayPalEnvironmentProduction: "Accr-ZtYarR7D-msqpy3pEn9U_I_IqCdihmy6PKezcI0Ae9ToIwCmY1gpKPi-xOy1GVfHaB5jNoSq1pu",
                                                                PayPalEnvironmentSandbox: "AVe468T9AfiKDFCSJFAC3fMSCuPSaRWzOgt1d_XJGYtFmGGga6DgGWKGu9F-gC59BlErJhw0mjoscz61"])
        GIDSignIn.sharedInstance().clientID = "360818511849-jvm2hgnd6bqs2a5tol6rue28qd1acrhs.apps.googleusercontent.com"
      ...
      //  Code for firebase
        ...
        //ObjServer.requestWith(endUrl: "https://341e9e33ee0e4315acaf0d0f67a4a2c6:835bf757ccfac46ce093174868f7c28e@ribbons-cheap-2.myshopify.com/cart/add.js",parameters: params)
