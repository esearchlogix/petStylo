...
class CartViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet var viewTotalPrice : UIView?
    ...
    @IBOutlet var  continueButtonSuper : UIButton?
    ...
    func fetchCartItems(){
        ...
        do {
            ...
            viewForEmptyCart?.isHidden = false
                ...
                viewTotalPrice?.isHidden = true
                continueButton?.isHidden = true
                continueButtonSuper?.isHidden = true

                self.methodToSetBottamNavigationBar(title: "My Cart")

            }else{
                viewForEmptyCart?.isHidden = true
                viewTotalPrice?.isHidden = false
                continueButtonSuper?.isHidden = false
...
// MARK: - tableViewDelegate
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        Utility.giveDoubleBorderToView(view: cell.productQuantitiView!, colour: UIColor.black)
        Utility.giveBorderToView(view: cell.productImageSuperView!, colour: UIColor.init(red: 247.0/255.0, green:166.0/255.0, blue: 28.0/255.0, alpha: 1.0))
         ...
         print(checkout)
                ...
                if isLogIn == true{
                    ...
                    if tokenActiveDate > Date(){
                                ...
                                let destinationViewController = ShipmentViewController(nibName: "ShipmentViewController", bundle: nil)
                                destinationViewController.totalCartPrice = self.totalPrice
                                destinationViewController.stringCheckoutID = checkout.checkout?.id.rawValue
                        destinationViewController.checkoutViewShipment = checkout.checkout?.viewModel
