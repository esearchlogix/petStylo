...
//         ObjServer.hitGetRequest(url:"https://a74ea1421fb13439b649fe9d44e0f3f6:3b423920ac3190c872a7c1569763da3f@petstylo.myshopify.com/admin/orders.json", inputIsJson: false, parametresJsonDic:nil, parametresJsonArray: nil,callingViewController:self, completion: {_,_,_ in })
        super.viewDidLoad()
  ...
  // MARK: - tableView delegate
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        buttonDetail.backgroundColor = UIColor.init(red: 247.0/255.0, green:166.0/255.0, blue: 28.0/255.0, alpha: 1.0)
    ...
    // Code for return Button/cancel button
        ...
        if ((orderArray?.object(at: indexPath.section) as? NSDictionary)?.object(forKey: "fulfillments") as? NSArray)?.count == 0{
         ...
         Utility.giveBorderToView(view: (cell?.imageSuperView)!, colour: UIColor.init(red: 247.0/255.0, green:166.0/255.0, blue: 28.0/255.0, alpha: 1.0))
...
//    }
    ...
    @objc func buttonClicked(sender: UIButton!) {
        let alertController = UIAlertController(title:kAppName, message:"If you want to cancel/return your product, then you can contact us on info@feuzy.com . Support team  contact to you after recieving your E-mail. " , preferredStyle: .alert)
